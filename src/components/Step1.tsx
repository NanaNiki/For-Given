...
export default function Step1() {
  return (
    <div className="w-screen h-fit text-center flex flex-col py-20">
      <h1 className="text-5xl font-extrabold pb-16">{content.title}</h1>
      <div className="w-10/12 mx-auto absolute">      
      <Parallax translateX={[80, 0]} opacity={[0, 1]}>
        <img src="/images/awaken.svg" alt="awaken" className="w-[27%] -mt-24" />
      </Parallax>
      </div>
      <p className="text-center mx-auto text-2xl w-6/12 my-16">
        {content.description}
      </p>
